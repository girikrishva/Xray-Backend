...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "deleted_at",  :index=>{:name=>"index_roles_on_deleted_at"}
  end
...
SELECT lookups.id,
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.string   "updated_by"
    t.string   "ip_address"
    t.datetime "deleted_at",            :index=>{:name=>"index_projects_on_deleted_at"}
  end
...
SELECT lookups.id,
  ...
  create_table "invoicing_milestones", force: :cascade do |t|
    ...
    t.datetime "deleted_at",         :index=>{:name=>"index_invoicing_milestones_on_deleted_at"}
  end
...
SELECT lookups.id,
  ...
  create_table "invoice_lines_audits", force: :cascade do |t|
    ...
    t.string   "updated_by"
    t.string   "ip_address"
    t.integer  "invoice_line_id",        :null=>false, :index=>{:name=>"index_invoice_lines_audits_on_invoice_line_id"}, :foreign_key=>{:references=>"invoice_lines", :name=>"fk_invoice_lines_audits_invoice_line_id", :on_update=>:no_action, :on_delete=>:no_action}
    t.integer  "invoice_header_id",      :null=>false, :index=>{:name=>"index_invoice_lines_audits_on_invoice_header_id"}, :foreign_key=>{:references=>"invoice_headers", :name=>"fk_invoice_lines_audits_invoice_header_id", :on_update=>:no_action, :on_delete=>:no_action}
...
SELECT lookups.id,
  ...
  create_table "payment_headers", force: :cascade do |t|
    ...
    t.string   "updated_by"
    t.string   "ip_address"
    t.datetime "deleted_at",        :index=>{:name=>"index_payment_headers_on_deleted_at"}
  end

  create_table "payment_headers_audits", force: :cascade do |t|
    t.string   "narrative",         :null=>false
    t.date     "payment_date",      :null=>false
    t.float    "header_amount",     :null=>false
    t.string   "comments"
...
SELECT lookups.id,
  ...
  create_table "pipelines_audits", force: :cascade do |t|
    ...
    t.string   "updated_by"
    t.string   "ip_address"
    t.datetime "deleted_at",            :index=>{:name=>"index_pipelines_audits_on_deleted_at"}
  end
