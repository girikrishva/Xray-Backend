Rails.application.routes.draw do
  ...
  match '/admin/api/tester' => 'admin/dashboard#tester', via: [:get]
  ...
  match '/admin/api/pipeline_by_stage_panel_data' => 'admin/dashboard#pipeline_by_stage_panel_data', via: [:get]
