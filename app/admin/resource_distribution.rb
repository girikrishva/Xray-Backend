ActiveAdmin.register AdminUser, as:"Resource Distribution" do
  menu if: proc { is_menu_authorized? [I18n.t('role.manager')] }, label: "Resource Distribution", parent: I18n.t('menu.reports'), priority: 10
